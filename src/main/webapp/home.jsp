                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div id="stateDropDown" class="col-md-4 col-md-pull-1 dropdown">
                                    <button class="btn btn-default dropdown-toggle" type="button" name="dropdownMenu1" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">
                                        ...
                                        <input type="hidden" name="filterState" id="filterState">
                                    </button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-md-pull-2">
                                    <input class="filterInput" type="text" name="filterPost" id="filterPost" placeholder="Post Code" size="8">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input class="filterInput" type="text" name="filterCity" id="filterCity" placeholder="City">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-md-pull-1 h4">
                                ...
                                <div class="col-md-6 col-md-pull-1">
                                    <input class="filterInput" type="text" name="filterName" id="filterName" placeholder="Hotel Name">
                                </div>
                            </div>
                        </div>
                </form>
